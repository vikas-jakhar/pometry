...
const CommonButton = (props) => {
  return (
    <button className={`${props.className} py-2.5 hover:shadow-3xl overflow-hidden border group duration-300 ease-linear relative rounded px-8 font-semibold text-base`}>{props.text}
