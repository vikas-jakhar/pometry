        ...
        <div className='min-h-screen w-full bg-white z-[100] fixed top-0 left-0 grid place-items-center'>
            <div className='animate-pulse flex max-sm:flex-col gap-5 sm:gap-8 justify-center sm:items-end'>
                ...
                <div class="flex-col gap-4 w-full flex items-center justify-center">
                    <div
                        class="sm:w-20 w-10 h-10 sm:h-20 border-4 border-transparent text-blue-400 text-4xl animate-spin flex items-center justify-center border-t-blue-400 rounded-full"
                    >
                        <div
                            class="sm:w-16 w-10 h-10 sm:h-16 border-4 border-transparent text-red-400 text-2xl animate-spin flex items-center justify-center border-t-red-400 rounded-full"
                        ></div>
                    </div>
                </div>
            </div>
