    ...
    <div className='container lg:py-[152px] md:py-20 sm:py-16 py-14'>
      <div className='flex lg:flex-row flex-col lg:justify-between max-lg:items-center'>
        <div className='max-w-[570px] w-full flex max-lg:justify-center' data-aos="fade-up-right">
          <img rel='preload' loading='lazy' className='lg:max-w-[570px] pointer-events-none max-w-[400px] w-full ' src={timeData} alt="#" />
        </div>
        <div className='max-w-[478px] w-git full relative' data-aos="fade-up-left">
          <CommonHeading className='max-w-[478px] max-lg:text-center' text='A real-time Data Time Machine' />
