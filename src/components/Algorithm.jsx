            ...
            <div className='container relative z-20'>
                <div className='flex max-lg:flex-wrap max-lg:justify-center items-center justify-between'>
                    ...
                    <div className='flex flex-col ps-6 max-lg:ps-0 xl:ps-0 max-lg:pt-12'>
                        ...
                        <CommonButton text="Read more" className="mt-[42px] max-lg:mx-auto max-w-[148px] hover:text-white text-nowrap border-darkRed hover:shadow-darkRed text-darkRed hover:border-white" hoverClass="bg-darkRed-gradient" />
                    </div>
                </div>
            </div>
