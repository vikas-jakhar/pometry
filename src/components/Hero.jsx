                    ...
                    <div className="lg:w-1/2 w-full flex justify-center items-center">
                        <div className="relative max-w-[338px] w-full mx-8">
                            ...
                            {SOCIAL_ICONS.map((items, index) => (
                                <a key={index} href={items.link} className={`${items.position} grid place-items-center bg-white sm:w-[74px] w-16 h-16 sm:h-[74px] shadow-4xl rounded-full hover:shadow-darkRed duration-300 ease-linear hover:shadow-3xl absolute`}>
