                ...
                <div className="mt-12 flex flex-col-reverse items-center lg:flex-row">
                    <div className="lg:w-1/2 w-full flex justify-center items-center">
                        <div className="relative max-w-[338px] w-full mx-8">
                            ...
                            {SOCIAL_ICONS.map((items, index) => (
                                <a key={index} href={items.link} target='_blank' rel="noreferrer" className={`${items.position} grid place-items-center bg-white sm:w-[74px] w-16 h-16 sm:h-[74px] shadow-4xl rounded-full hover:shadow-darkRed duration-300 ease-linear hover:shadow-3xl absolute`}>
                    ...
                    <div className="lg:w-1/2 w-full mb-20 lg:mb-0 flex justify-center items-center">
                        <div className="max-w-[509px] w-full relative">
                            ...
                            <Icons IconName="arrowIcon" className="absolute w-[70px] md:w-auto lg:right-[104px] -top-9 right-9 lg:-top-1.5 hidden sm:flex" />
